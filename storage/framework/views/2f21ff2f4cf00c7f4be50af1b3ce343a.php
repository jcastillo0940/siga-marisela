    ...
    <header class="bg-white shadow-sm border-b-4 border-red-600 no-print">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex justify-between items-center">
                <div>
                    <a href="<?php echo e(route('attendance.sessions', $offering->id)); ?>" class="text-sm text-red-600 hover:text-red-700 mb-2 inline-block">← Volver a sesiones</a>
                    <h1 class="text-3xl font-display font-bold text-gray-900">Reporte de Asistencia</h1>
                    <p class="text-gray-600 mt-1"><?php echo e($offering->full_name); ?></p>
                </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-gray-400">
                ...
                <p class="text-3xl font-display font-bold text-gray-900"><?php echo e($report['summary']['total_students']); ?></p>
            </div>
            <div class="bg-green-50 rounded-lg shadow-md p-6 border-l-4 border-green-500">
                ...
                <p class="text-3xl font-display font-bold text-green-700"><?php echo e($report['summary']['eligible_for_certificate']); ?></p>
            </div>
            <div class="bg-blue-50 rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                ...
                <p class="text-3xl font-display font-bold text-blue-700"><?php echo e(number_format($report['summary']['average_attendance'], 1)); ?>%</p>
            </div>
            <div class="bg-purple-50 rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                ...
                <p class="text-3xl font-display font-bold text-purple-700"><?php echo e($report['course']['total_sessions']); ?></p>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $report['students']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center no-print">
                                    <div class="flex gap-4 justify-center">
                                        <a href="<?php echo e(route('attendance.student-report', $student['enrollment_id'])); ?>" 
                                        ...
                                        <?php if($student['can_generate_certificate']): ?>
                                            <form action="<?php echo e(route('certificates.generate', $student['enrollment_id'])); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" 
                                                        class="inline-flex items-center text-green-600 hover:text-green-900 text-sm font-bold"
                                                        onclick="return confirm('¿Generar certificado para <?php echo e($student['student_name']); ?>?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/attendance/course-report.blade.php ENDPATH**/ ?>