...
<?php $__env->startSection('title', 'Gestión de Caja'); ?>
<?php $__env->startSection('page-title', 'Gestión de Caja'); ?>
...
<div class="fade-in">
        ...
        <div class="card-premium bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300">
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <h2 class="text-2xl font-display font-semibold text-primary-dark"><?php echo e($activeCashRegister->code); ?></h2>
                        <p class="text-sm text-gray-500">Operador: <?php echo e($activeCashRegister->openedBy->name); ?></p>
                    </div>
                </div>
                
                <div class="text-right">
                    <p class="text-sm text-gray-600">Fondo Inicial</p>
                    <p class="text-3xl font-display font-bold text-green-600"><?php echo e($activeCashRegister->formatted_opening_amount); ?></p>
                    <p class="text-xs text-gray-500 mt-1"><?php echo e($activeCashRegister->opened_at->diffForHumans()); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4 mb-6">
                <div class="bg-white rounded-lg p-4 text-center">
                    ...
                    <p class="text-2xl font-display font-bold text-blue-600">$<?php echo e(number_format($activeCashRegister->total_payments, 2)); ?></p>
                </div>
                <div class="bg-white rounded-lg p-4 text-center">
                    <p class="text-sm text-gray-600 mb-1">Total Transacciones</p>
                    <p class="text-2xl font-display font-bold text-purple-600"><?php echo e($activeCashRegister->payments->count()); ?></p>
                </div>
                <div class="bg-white rounded-lg p-4 text-center">
                    <p class="text-sm text-gray-600 mb-1">Total en Caja</p>
                    <p class="text-2xl font-display font-bold text-green-600">$<?php echo e(number_format($activeCashRegister->opening_amount + $activeCashRegister->total_payments, 2)); ?></p>
                </div>
            </div>

            <div class="flex space-x-4">
                <a href="<?php echo e(route('pos.index')); ?>" class="btn-primary flex-1 text-center">
    ...
    <div class="max-w-2xl mx-auto">
        <div class="card-premium">
            ...
            <form method="POST" action="<?php echo e(route('cash-registers.open')); ?>">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   id="opening_amount" 
                                   name="opening_amount" 
                                   value="<?php echo e(old('opening_amount', 0)); ?>"
                                   class="w-full pl-12 pr-4 py-4 text-3xl font-display font-bold text-right border-2 border-blue-500 rounded-lg focus:ring-4 focus:ring-blue-200 <?php $__errorArgs = ['opening_amount'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="opening_notes" 
                                  name="opening_notes" 
                                  rows="3"
                                  class="input-elegant <?php $__errorArgs = ['opening_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Notas u observaciones al abrir caja..."><?php echo e(old('opening_notes')); ?></textarea>
                        <?php $__errorArgs = ['opening_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<div id="close-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl max-w-md w-full mx-4">
        <form method="POST" action="<?php echo e(route('cash-registers.close', $activeCashRegister->id ?? 0)); ?>">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/cash-registers/index.blade.php ENDPATH**/ ?>