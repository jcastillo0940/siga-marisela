    ...
    <div class="card-premium">
        ...
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <a href="<?php echo e(route('student-dashboard.index', $student->id)); ?>"
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <?php if($student->identification): ?>
                                <p class="text-xs text-gray-400">ID: <?php echo e($student->identification); ?></p>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/student-dashboard/select.blade.php ENDPATH**/ ?>