...
<?php $__env->startSection('title', 'Detalles del Lead'); ?>
<?php $__env->startSection('page-title', 'Detalles del Lead'); ?>
...
<div class="fade-in">
        ...
        <nav class="flex text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-2">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('leads.index')); ?>" class="text-gray-500 hover:text-accent-red transition-colors">
                        Leads
                    </a>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-700 font-medium"><?php echo e($lead->full_name); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div class="flex items-center space-x-4 sm:space-x-6">
            ...
            <div class="flex-shrink-0">
                <?php if($lead->student_photo): ?>
                    ...
                    <img src="<?php echo e(asset('storage/' . $lead->student_photo)); ?>" 
                         alt="<?php echo e($lead->full_name); ?>" 
            ...
            <div>
                ...
                <div class="flex flex-wrap items-center gap-3 text-gray-600">
                    <a href="mailto:<?php echo e($lead->email); ?>" class="flex items-center hover:text-accent-red transition-colors text-sm sm:text-base">
                    ...
                    <a href="tel:<?php echo e($lead->phone); ?>" class="flex items-center hover:text-accent-red transition-colors text-sm sm:text-base">
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex flex-wrap items-center gap-2 mt-3">
                    ...
                    <span class="px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($payStatusColors[$lead->payment_status] ?? 'bg-gray-100'); ?>">
                        Pago: <?php echo e(ucfirst($lead->payment_status)); ?>
        ...
        <div class="flex space-x-3 w-full sm:w-auto">
            ...
            <a href="<?php echo e(route('leads.edit', $lead->id)); ?>" class="btn-primary flex-1 sm:flex-none text-center">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('leads.index')); ?>" class="btn-secondary flex-1 sm:flex-none text-center">
                Volver
            </a>
        </div>
    </div>
    ...
    <?php if($lead->payment_status === 'pending' && !$lead->isConverted() && $lead->payment_receipt_path): ?>
    <div class="card-premium border-2 border-accent-red mb-8 bg-red-50/20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
                ...
                <a href="<?php echo e(asset('storage/' . $lead->payment_receipt_path)); ?>" target="_blank" class="block group">
                    <img src="<?php echo e(asset('storage/' . $lead->payment_receipt_path)); ?>" class="w-full h-64 object-contain bg-white rounded-lg border shadow-sm transition-transform group-hover:scale-[1.01]">
                    <span class="text-xs text-blue-600 mt-2 block font-medium">Click para abrir en pantalla completa ↗</span>
                </a>
            </div>
            <div class="flex flex-col justify-center">
                <form action="<?php echo e(route('leads.verify-payment', $lead->id)); ?>" method="POST" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div>
            ...
            <div class="card-premium">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-primary-dark font-medium"><?php echo e($lead->birth_date_text ?? 'No registrada'); ?></p>
                    </div>
                    <div>
                        <label class="label-elegant">Edad</label>
                        <p class="text-primary-dark font-medium"><?php echo e($lead->age ?? 'No calculada'); ?> años</p>
                    </div>
                    <div>
                        <label class="label-elegant">Ocupación / Actividad</label>
                        <p class="text-primary-dark font-medium"><?php echo e($lead->occupation ?? 'No registrada'); ?></p>
                    </div>
                    <div>
                        <label class="label-elegant">Instagram/TikTok</label>
                        <p class="text-primary-dark font-medium"><?php echo e($lead->social_media_handle ?? 'No registrado'); ?></p>
                    </div>
                    <div class="md:col-span-2">
                        <label class="label-elegant">Dirección Completa</label>
                        <p class="text-primary-dark font-medium"><?php echo e($lead->address_full ?? 'No registrada'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-premium">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-primary-dark font-medium"><?php echo e($lead->parent_name); ?> (<?php echo e($lead->parent_relationship); ?>)</p>
                    </div>
                    <div>
                        <label class="label-elegant">Teléfono del Tutor</label>
                        <p class="text-primary-dark font-medium"><?php echo e($lead->parent_phone); ?></p>
                    </div>
                    <div class="md:col-span-2">
                        <label class="label-elegant">Ocupación del Tutor</label>
                        <p class="text-primary-dark font-medium"><?php echo e($lead->parent_occupation ?? 'No registrada'); ?></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="card-premium">
                ...
                <div class="space-y-4 text-sm">
                    <div class="flex justify-between border-b border-slate-50 pb-2">
                        ...
                        <span class="font-semibold text-primary-dark">#<?php echo e($lead->id); ?></span>
                    </div>
                    <div>
                        <label class="text-gray-500 text-xs uppercase block mb-1">Fecha de registro</label>
                        <p class="text-primary-dark font-medium"><?php echo e($lead->created_at->format('d/m/Y H:i')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/leads/show.blade.php ENDPATH**/ ?>