...
<div class="max-w-4xl mx-auto py-12 px-4 fade-in">
    ...
    <form action="<?php echo e(route('public.leads.store')); ?>" method="POST" enctype="multipart/form-data" id="registrationForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="card-premium mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="first_name" class="input-elegant" required placeholder="Nombres" value="<?php echo e(old('first_name')); ?>">
                </div>
                <div>
                    <label class="label-elegant">Apellidos *</label>
                    <input type="text" name="last_name" class="input-elegant" required placeholder="Apellidos" value="<?php echo e(old('last_name')); ?>">
                </div>
                <div>
                    <label class="label-elegant">Correo electrónico *</label>
                    <input type="email" name="email" class="input-elegant" required placeholder="correo@ejemplo.com" value="<?php echo e(old('email')); ?>">
                </div>
                <div>
                    <label class="label-elegant">Celular de contacto *</label>
                    <input type="tel" name="phone" class="input-elegant" required placeholder="6000-0000" value="<?php echo e(old('phone')); ?>">
                </div>
                <div>
                    <label class="label-elegant">Fecha de nacimiento *</label>
                    <input type="date" name="birth_date_text" id="birth_date" class="input-elegant" required onchange="checkAge()" value="<?php echo e(old('birth_date_text')); ?>">
                </div>
                <div>
                ...
                <input type="hidden" name="age" id="age_hidden" value="<?php echo e(old('age')); ?>">
            </div>
        </div>
        ...
        <div id="tutor_section" class="card-premium mb-8 hidden bg-slate-50 border-accent-red border-l-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="parent_name" class="input-elegant tutor-field" placeholder="Nombre completo" value="<?php echo e(old('parent_name')); ?>">
                </div>
                <div>
                    <label class="label-elegant">Parentesco *</label>
                    <select name="parent_relationship" class="input-elegant tutor-field">
                        <option value="Madre" <?php echo e(old('parent_relationship') == 'Madre' ? 'selected' : ''); ?>>Madre</option>
                        <option value="Padre" <?php echo e(old('parent_relationship') == 'Padre' ? 'selected' : ''); ?>>Padre</option>
                        <option value="Tutor" <?php echo e(old('parent_relationship') == 'Tutor' ? 'selected' : ''); ?>>Tutor Legal</option>
                    </select>
                </div>
                <div>
                    <label class="label-elegant">Celular del Tutor *</label>
                    <input type="tel" name="parent_phone" class="input-elegant tutor-field" placeholder="6000-0000" value="<?php echo e(old('parent_phone')); ?>">
                </div>
                <div>
                    <label class="label-elegant">Ocupación del Tutor *</label>
                    <input type="text" name="parent_occupation" class="input-elegant tutor-field" value="<?php echo e(old('parent_occupation')); ?>">
                </div>
            </div>
        </div>
        ...
        <div class="card-premium mb-8">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div>
                    ...
                    <textarea name="address_full" class="input-elegant" rows="2" required placeholder="Indica tu dirección residencial"><?php echo e(old('address_full')); ?></textarea>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="label-elegant">¿A qué te dedicas actualmente? *</label>
                        <input type="text" name="occupation" class="input-elegant" required placeholder="Estudiante, Profesional, etc." value="<?php echo e(old('occupation')); ?>">
                    </div>
                    <div>
                        <label class="label-elegant">Usuario de Instagram/TikTok</label>
                        <input type="text" name="social_media_handle" class="input-elegant" placeholder="@usuario" value="<?php echo e(old('social_media_handle')); ?>">
                    </div>
                </div>
                <div>
                    <label class="label-elegant">¿Hay algo que debamos saber? (Alergias, condiciones, etc.)</label>
                    <textarea name="medical_notes_lead" class="input-elegant" rows="2" placeholder="Notas médicas importantes"><?php echo e(old('medical_notes_lead')); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="card-premium mb-8">
            ...
            <textarea name="notes" class="input-elegant" rows="3" placeholder="¿Algo más que quieras que sepamos?"><?php echo e(old('notes')); ?></textarea>
        </div>
...
<script>
    ...
    async function calculateTotal() {
        ...
        try {
            const response = await fetch('<?php echo e(route("api.public.calculate-price")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/public/leads/register.blade.php ENDPATH**/ ?>