<?php $__env->startSection('title', 'Punto de Venta - Productos'); ?>
<?php $__env->startSection('page-title', 'POS - Venta de Productos y Servicios'); ?>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card-premium">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3 max-h-96 overflow-y-auto">
                        ...
                        <button type="button"
                                onclick="addProductToCart(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', <?php echo e($product->price); ?>, <?php echo e($product->track_inventory ? 1 : 0); ?>, <?php echo e($product->stock); ?>)"
                                class="p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition text-left">
                            <p class="font-semibold text-sm"><?php echo e($product->name); ?></p>
                            <p class="text-lg font-bold text-purple-600">$<?php echo e(number_format($product->price, 2)); ?></p>
                            <?php if($product->track_inventory): ?>
                            <p class="text-xs text-gray-500">Stock: <?php echo e($product->stock); ?></p>
                            <?php endif; ?>
                        </button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/sales/pos.blade.php ENDPATH**/ ?>