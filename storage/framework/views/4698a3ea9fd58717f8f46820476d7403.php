    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="card-premium">
            ...
            <div class="flex items-end justify-between">
                <div>
                    <p class="text-4xl font-display font-semibold text-primary-dark"><?php echo e($stats['total_users']); ?></p>
        ...
        <div class="card-premium">
            ...
            <div class="flex items-end justify-between">
                <div>
                    <p class="text-4xl font-display font-semibold text-primary-dark"><?php echo e($stats['total_roles']); ?></p>
        ...
        <div class="card-premium opacity-50">
            ...
            <div class="flex items-end justify-between">
                <div>
                    <p class="text-4xl font-display font-semibold text-primary-dark"><?php echo e($stats['total_students']); ?></p>
        ...
        <div class="card-premium opacity-50">
            ...
            <div class="flex items-end justify-between">
                <div>
                    <p class="text-4xl font-display font-semibold text-primary-dark"><?php echo e($stats['total_enrollments']); ?></p>
                    <p class="text-sm text-gray-500 mt-1">Próximamente</p>
                </div>
            </div>
        </div>
...
<div class="card-premium mb-8">
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h2 class="text-2xl font-display font-semibold text-primary-dark mb-1">
                <?php echo e($user->greeting); ?>, <?php echo e($user->name); ?>! 
            </h2>
            <p class="text-gray-600">
                Rol: <span class="text-accent-red font-medium"><?php echo e($user->roles->pluck('name')->join(', ') ?: 'Usuario'); ?></span>
            </p>
        </div>
    </div>
</div>
    ...
    <div class="card-premium">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="<?php echo e(route('users.index')); ?>" class="flex items-center p-4 bg-neutral-bg rounded hover:bg-gray-100 transition-colors duration-200">
            ...
            <a href="<?php echo e(route('roles.index')); ?>" class="flex items-center p-4 bg-neutral-bg rounded hover:bg-gray-100 transition-colors duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/dashboard.blade.php ENDPATH**/ ?>