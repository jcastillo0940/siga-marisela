    ...
    <header class="bg-white shadow-sm border-b-4 border-red-600 no-print">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex justify-between items-center">
                <div>
                    <a href="<?php echo e(route('attendance.course-report', $enrollment->course_offering_id)); ?>" class="text-sm text-red-600 hover:text-red-700 mb-2 inline-block">← Volver al reporte del curso</a>
                    <h1 class="text-3xl font-display font-bold text-gray-900">Reporte Individual de Asistencia</h1>
                    <p class="text-gray-600 mt-1"><?php echo e($enrollment->student->full_name); ?></p>
                </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div>
                    ...
                    <dl class="space-y-3">
                        <div>
                            ...
                            <dd class="text-base font-medium text-gray-900"><?php echo e($enrollment->student->full_name); ?></dd>
                        </div>
                        <div>
                            <dt class="text-xs uppercase tracking-wider text-gray-500">Documento de Identidad</dt>
                            <dd class="text-base font-medium text-gray-900"><?php echo e($enrollment->student->identification); ?></dd>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <dt class="text-xs uppercase tracking-wider text-gray-500">Email</dt>
                                <dd class="text-sm text-gray-900"><?php echo e($enrollment->student->email); ?></dd>
                            </div>
                            <div>
                                <dt class="text-xs uppercase tracking-wider text-gray-500">Teléfono</dt>
                                <dd class="text-sm text-gray-900"><?php echo e($enrollment->student->phone); ?></dd>
                            </div>
                        </div>
                    </dl>
                </div>
                <div>
                    ...
                    <dl class="space-y-3">
                        <div>
                            ...
                            <dd class="text-base font-medium text-gray-900"><?php echo e($enrollment->courseOffering->full_name); ?></dd>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <dt class="text-xs uppercase tracking-wider text-gray-500">Código de Inscripción</dt>
                                <dd class="text-sm font-mono text-gray-900"><?php echo e($enrollment->enrollment_code); ?></dd>
                            </div>
                            <div>
                                <dt class="text-xs uppercase tracking-wider text-gray-500">Fecha de Alta</dt>
                                <dd class="text-sm text-gray-900"><?php echo e($enrollment->enrollment_date->format('d/m/Y')); ?></dd>
                            </div>
                        </div>
                        <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-8">
            <div class="bg-white rounded-lg shadow-md p-4 border-l-4 border-gray-400">
                ...
                <p class="text-2xl font-display font-bold text-gray-900"><?php echo e($stats['total_sessions']); ?></p>
            </div>
            <div class="bg-green-50 rounded-lg shadow-md p-4 border-l-4 border-green-500">
                ...
                <p class="text-2xl font-display font-bold text-green-700"><?php echo e($stats['attended']); ?></p>
            </div>
            ...
            <div class="bg-purple-50 rounded-lg shadow-md p-4 border-l-4 border-purple-500">
                ...
                <p class="text-2xl font-display font-bold text-purple-700"><?php echo e(number_format($stats['percentage'], 1)); ?>%</p>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $enrollment->attendances->sortBy('courseSession.class_date'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                    Sesión #<?php echo e($index + 1); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900"><?php echo e($attendance->courseSession->class_date->format('d/m/Y')); ?></div>
                                    <div class="text-xs text-gray-500 capitalize"><?php echo e($attendance->courseSession->class_date->locale('es')->isoFormat('dddd')); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="px-3 py-1 text-xs font-bold rounded-full <?php echo e($statusConfig['class']); ?>">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 <?php echo e($stats['percentage'] >= 80 ? 'border-green-500' : 'border-red-500'); ?>">
            <h3 class="text-lg font-display font-semibold text-gray-900 mb-4">Elegibilidad para Certificación</h3>
            <?php if($stats['percentage'] >= 80): ?>
            ...
            <?php else: ?>
                <div class="flex items-center p-4 bg-red-50 rounded-lg text-red-800">
                    ...
                    <div>
                        ...
                        <p class="text-sm">Se requiere un mínimo de 80% de asistencia. Faltan <?php echo e(number_format(80 - $stats['percentage'], 1)); ?>% para alcanzar el objetivo.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u545703374/domains/test.supercarnes.com/resources/views/attendance/student-report.blade.php ENDPATH**/ ?>