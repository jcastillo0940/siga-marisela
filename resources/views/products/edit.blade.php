...
@section('page-title', 'Editar Producto o Servicio')
        ...
        <form action="{{ route('products.update', $product) }}" method="POST">
            ...
            <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description"
                                      rows="3"
                                      class="input-elegant @error('description') border-red-500 @enderror">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div>
                    ...
                    <div id="inventory-fields" class="grid grid-cols-1 md:grid-cols-2 gap-6 {{ old('track_inventory', $product->track_inventory) ? '' : 'hidden' }}">
                        <div>
                            <label class="label-elegant">Stock Actual</label>
                            <input type="number"
                                   name="stock"
