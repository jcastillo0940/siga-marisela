...
@section('page-title', 'Nuevo Menú de Comida')
...
<div class="fade-in">
    ...
    <form action="{{ route('meal-menus.store') }}" method="POST" enctype="multipart/form-data" id="menuForm">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="course_offering_id" id="courseOffering" class="input-elegant" required>
                                ...
                                <option value="{{ $offering->id }}" data-dates='{{ $offering->dates_json }}'>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="menu_description" 
                                      ...
                                      required>{{ old('menu_description') }}</textarea>
            ...
            <div class="space-y-6">
                ...
                <div class="card-premium">
                    ...
                    <a href="{{ route('meal-menus.index') }}" class="btn-secondary w-full">
                        Cancelar
                    </a>
                </div>
            </div>
